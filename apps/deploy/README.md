...
| Path | Purpose |
|------|---------|
| [`docs/vps-bootstrap.md`](../../docs/vps-bootstrap.md) | One-time VPS setup (MySQL, data, configs, runner) |
...
**Backups:** see [`docs/recovery.md`](../../docs/recovery.md). Run `backup-acore.sh` regularly and store the tarball off the VPS.
