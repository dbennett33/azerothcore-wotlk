...
echo ""
echo "Commit client-patches/manifest.json with the matching C++/SQL:"
echo "  push dev        → deploy-vps applies this overlay to Test"
echo "  merge Playerbot → deploy-vps applies this overlay to Live"
