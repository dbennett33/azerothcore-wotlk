...
| [`build-creature-model`](../.agents/skills/build-creature-model/SKILL.md) | A new animated creature shape (not a reused display id): mesh onto a Blizzard rig, BLP2, DBC 60000+, pack into `patch-4`. | Scripts under the skill; human docs in [`custom-npc-skills/`](custom-npc-skills/README.md). |
| [`build-dungeon`](../.agents/skills/build-dungeon/SKILL.md) | Designing or implementing a 5-man: hosting choice, mesh, content density, loot, entrance. | [`reference-mesh.md`](../.agents/skills/build-dungeon/reference-mesh.md) (WMO/WDT/extract pipeline), [`reference-blender-wmo.md`](../.agents/skills/build-dungeon/reference-blender-wmo.md) (Blender 3.4.1 + WBS kitbash — the art path), [`reference-content.md`](../.agents/skills/build-dungeon/reference-content.md) (what a finished dungeon contains), [`reference-new-map.md`](../.agents/skills/build-dungeon/reference-new-map.md) (**dungeon #3+**: new `Map.dbc` id on client and server; do not reuse leftover instance maps). |
