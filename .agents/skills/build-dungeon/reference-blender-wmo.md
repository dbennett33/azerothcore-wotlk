...
6. Every playable room lives in the WBS **Indoor** collection (MOGP `INTERIOR` `0x2000` on
   ...
   group. WBS writes **MOPY `0x20`** (F_RENDER) when all three verts are in that group, **`0x24`**
   if the group is incomplete, and **`0x08`** only on a separate Collision-collection mesh
